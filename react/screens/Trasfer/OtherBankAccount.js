    ...
    otherBankAccountDetails(language){
        ...
        <View style={{height: 1, backgroundColor: themeStyle.SEPARATOR}}/>
                ...
                <View style={{
                    ...
                    <Text style={CommonStyle.viewText}>{this.state.nick_name}</Text>
                </View>
                <View style={{height: 1, backgroundColor: themeStyle.SEPARATOR}}/>
                ...
                <View style={{
                    ...
                    <Text style={[CommonStyle.textStyle]}>
                        {language.selectActType}
                    </Text>
                    <Text style={CommonStyle.viewText}>{this.state.accountType}</Text>
                </View>
                <View style={{height: 1, backgroundColor: themeStyle.SEPARATOR}}/>
                <View style={{
                    flexDirection: "row", height: Utility.setHeight(50), marginStart: 10, alignItems: "center",
                    ...
                    <Text style={CommonStyle.viewText}>{this.state.transferMode}</Text>
                </View>
                <View style={{height: 1, backgroundColor: themeStyle.SEPARATOR}}/>
                <View style={{
                    flexDirection: "row", height: Utility.setHeight(50), marginStart: 10, alignItems: "center",
                ...
                <View style={{
                    ...
                    <Text style={CommonStyle.viewText}>{this.state.bankName}</Text>
                </View>
                <View style={{height: 1, backgroundColor: themeStyle.SEPARATOR}}/>
                <View style={{
                    flexDirection: "row", height: Utility.setHeight(50), marginStart: 10, alignItems: "center",
                    ...
                    <Text style={CommonStyle.viewText}>{this.state.districtName}</Text>
                </View>
                <View style={{height: 1, backgroundColor: themeStyle.SEPARATOR}}/>
                <View style={{
                    flexDirection: "row", height: Utility.setHeight(50), marginStart: 10, alignItems: "center",
                    ...
                    <Text style={CommonStyle.viewText}>{this.state.branchName}</Text>
                </View>
                <View style={{height: 1, backgroundColor: themeStyle.SEPARATOR}}/>
                <View style={{
                    flexDirection: "row", height: Utility.setHeight(50), marginStart: 10, alignItems: "center",
                ...
                <View style={{
                    ...
                    <Text style={CommonStyle.viewText}>{this.state.otpType}</Text>
                </View>
                <View style={{height: 1, backgroundColor: themeStyle.SEPARATOR}}/>
