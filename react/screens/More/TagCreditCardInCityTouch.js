    ...
    tagCreditCard(language){
        return(
            <View key={"tagCreditCard"}>
                ...
                <View style={{height: 1, backgroundColor: themeStyle.SEPARATOR}}/>
                    <View style={{marginStart:10,marginEnd:10,marginTop:10,marginBottom:10, borderColor: themeStyle.BORDER,
                        borderRadius: 5,
                        overflow: "hidden",
                        borderWidth: 2}}>
    ...
    render() {
        ...
        return (<View style={{flex: 1, backgroundColor: themeStyle.BG_COLOR}}>
                ...
                <ScrollView showsVerticalScrollIndicator={false}>
                    <Text style={{marginTop:Utility.setWidth(10),marginStart: Utility.setWidth(10),marginEnd:Utility.setWidth(10) }}>{language.tagCreditTitle}</Text>
                    ...
                    <View style={{flex: 1, paddingBottom: 30}}>
                        ...
                        <Text style={{marginStart: Utility.setWidth(10), marginTop: Utility.setWidth(10),marginBottom:Utility.setWidth(10),color:themeStyle.THEME_COLOR}}>*{language.mark_field_mandatory}</Text>
                    </View>
                    </View>
                </ScrollView>
